...
<html lang="@lang@">
    <head>
        ...
        <link rel="preload" href="@pathTemplateMin@css/@diggi_fluid_theme@.css" as="style">
    ...
    <body id="body" data-dir="@ShopDir@" data-path="@php echo $GLOBALS['PHPShopNav']->objNav['path']; php@" data-id="@php echo $GLOBALS['PHPShopNav']->objNav['id']; php@" data-token="@dadataToken@">
        ...
        <!-- Theme -->
        <link id="bootstrap_theme" data-name="@php echo $_SESSION['skin']; php@" href="@pathTemplateMin@css/@diggi_fluid_theme@.css" rel="stylesheet">
...
<a href="/catalog/" id="nav-catalog-dropdown-link" class="nav-catalog-dropdown-link" aria-expanded="false">{Весь каталог}</a>
