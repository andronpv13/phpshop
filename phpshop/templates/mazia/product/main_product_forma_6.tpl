<div class="col-auto5 col-xl-2 col-sm-4 col-lg-3">
    <!-- Product -->
            ...
            <div class="product-desc pb-20">
                ...
                <div class="price-switcher">
                    ...
                    <div class="switcher-item">
                        ...
                        <a href="#" class="add-cart text-capitalize addToCartList @elementCartHide@ @hideCatalog@" data-uid="@productUid@">@productSale@</a>
                    </div>
