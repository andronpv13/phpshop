                        ...
                        <tbody>
                            ...
                            <tr>
                                <td bgcolor="#f3f3f3" align="center" height="60"
                                    style="font-size: 18px; color: #464646; font-weight: 700; background: #f3f3f3; border-radius:4px;font-family:    Helvetica, sans-serif; letter-spacing: 1px; ">{Доступ в личный кабинет}
                                </td>
                            </tr>

                            <tr>
                                <td
                                    style="color: #646464;font-family: Helvetica, sans-serif; font-size: 15px;line-height: 24px; margin-top: 15px; ">
...
<p>{Отслеживать статус заказа, распечатать платежные документы можно в} <a href="http://@serverPath@/users/order.html?order_info=@ouid@#Order">{Личном кабинете}</a>.</p>
                                    <p>{Получайте уведомления о заказе, задайте нам вопрос}@bot@ {через раздел} <a href="http://@serverPath@/users/message.html" target="_blank">{Диалоги}</a>.</p>
                                </td>
                            </tr>
                        </tbody>
                    </table>
