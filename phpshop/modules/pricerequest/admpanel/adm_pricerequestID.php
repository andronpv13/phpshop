...
<div class="media">
  <div class="media-left">
    <a href="?path=product&id=' . $data['product_id'] . '&return=modules.dir.pricerequest.' . $data['id'] . '" >
      ' . $icon . '
    </a>
  </div>
   <div class="media-body">
    <div class="media-heading"><a href="?path=product&id=' . $data['product_id'] . '&return=modules.dir.pricerequest.' . $data['id'] . '" >' . $data['product_name'] . '</a></div>
    ...
    $Tab1.= $PHPShopGUI->setField('Товар', $name);
