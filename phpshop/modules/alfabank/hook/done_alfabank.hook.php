 ...
 * @todo https://alfabank.ru/sme/payservice/internet-acquiring/docs/documentation/?rp-menuOpen=1&rp-path=ru%2Fintegration%2Fapi%2Frest.html%23authentication
 */
    ...
    if ($rout === 'END' and (int) $value['order_metod'] === 10021) {
        ...
        if ($PHPShopSystem->getParam('nds_enabled') == 1) {
            if ($PHPShopSystem->getParam('nds') == 0)
                $tax = 1;
            elseif ($PHPShopSystem->getParam('nds') == 5)
                $tax = 10;
            elseif ($PHPShopSystem->getParam('nds') == 7)
                $tax = 12;
            ...
            elseif ($PHPShopSystem->getParam('nds') == 20)
                $tax = 3;
            elseif ($PHPShopSystem->getParam('nds') == 22)
                $tax = 14;
        } else
            $tax = 0;
